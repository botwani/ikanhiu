...
const vcard = 'BEGIN:VCARD\n' // ANAK ANJING MAU NGAPAIN?
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6289527818905:+62 895-2781-8905\n' // JANGAN KEK BABI SU
...
const config = {
    A187: '👾VINBOT👾', // TOBAT SU ASU
    instagram: 'https://instagram.com/semblegedezzchanel', // INFO JANGAN DI UBAH
    nomer: 'wa.me/6289527818905', // INFO SU JNGAN DI UBAH
    youtube: 'https://youtube.com/channel/UCOCDpVEjEo7CFp7RcKru-MQ', // KINTIL
    whatsapp: 'https://chat.whatsapp.com/G7yWxY8olQt1sxQNkLGj2Z', // BABI
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6288238745613@s.whatsapp.net"] // ganti nomer lu
			...
			switch(command) {
				...
				case 'menu':
					...
					teks = `➽𝐍𝐚𝐦𝐚 𝐛𝐨𝐭 : ${me.name}\n➽𝐍𝐨𝐦𝐞𝐫 𝐛𝐨𝐭 : @${me.jid.split('@')[0]}\n➽𝐏𝐫𝐞𝐟𝐢𝐱 : ${prefix}\n➽𝐓𝐨𝐭𝐚𝐥 𝐛𝐥𝐨𝐜𝐤 : ${blocked.length}\n➽𝐀𝐤𝐭𝐢𝐟 𝐬𝐞𝐣𝐚𝐤 : ${kyun(uptime)}\n➽𝐈𝐧𝐬𝐭𝐚𝐠𝐫𝐚𝐦 : https://www.instagram.com/semblegedezzchanel\n➽𝐘𝐨𝐮𝐓𝐮𝐛𝐞 : https://youtube.com/channel/UCOCDpVEjEo7CFp7RcKru-MQ\n➽𝐒𝐜𝐫𝐢𝐩𝐭 𝐛𝐲 : 𝐕𝐈𝐍𝐁𝐎𝐓 𝟎𝟓 \n➽𝐒𝐩𝐞𝐜𝐢𝐚𝐥 𝐓𝐡𝐚𝐧𝐤𝐬 𝐭𝐨:\n➽𝐕𝐈𝐍𝐁𝐎𝐓 𝟎𝟓`
				...
				case 'logowolf':
					...
					if (args.length < 1) return reply(`teksnya mana? contoh ${prefix}logowolf Vin|Ganss`)
					reply(mess.wait)
              ...
              case 'abgjago':
				...
				case 'bc': 
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							client.sendMessage(_.jid, buff, image, {caption: `❮ 𝐏𝐄𝐒𝐀𝐍 𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓  𝐕𝐈𝐍𝐁𝐎𝐓 ❯\n\n${body.slice(4)}`})
						}
						reply('𝐬𝐮𝐜𝐜𝐬𝐬 𝐛𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭')
					} else {
						for (let _ of anu) {
							sendMess(_.jid, `❮ 𝐏𝐄𝐒𝐀𝐍 𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓   𝐕𝐈𝐍𝐁𝐎𝐓 ❯\n\n${body.slice(4)}`)
						}
						reply('𝐬𝐮𝐜𝐜𝐬𝐬 𝐛𝐫𝐨𝐚𝐝𝐜𝐚𝐬𝐭')
					}
					break
